...
/**
 * @brief Imprime as opcoes de uso
 */
void uso() {
...
/**
 * @brief programa principal para execucao de operacoes de matrizes
 * 
 * @param argc Ponteiro para a primeira matriz.
 * @param argv Ponteiro para a segunda matriz.
 * @return 0 Mostra que a função foi concluída até o final
 */
